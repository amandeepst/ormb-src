...
/**
  * Generated super class for the cmAdjustmentStagingILMBatch batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class CmAdjustmentStagingILMBatch_Gen extends AbstractBatchJob
{
...
public final String getMaintenanceObject () {
        String result = privateGetSoftParameter("maintenanceObject");
        if (result==null) reportRequiredParameter("maintenanceObject");
        return result;
}
    ...
    public abstract static class CmAdjustmentStagingILMBatchWorker_Gen
