...
/**
  * Generated super class for the replayFailedTransactionInterface batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class ReplayFailedTransactionInterface_Gen extends AbstractBatchJob
{
...
public final java.math.BigInteger getNumberOfReplays () {
        java.math.BigInteger result = privateGetIntegerSoftParameter("numberOfReplays");
        return result;
}
    ...
    public abstract static class ReplayFailedTransactionInterfaceWorker_Gen
