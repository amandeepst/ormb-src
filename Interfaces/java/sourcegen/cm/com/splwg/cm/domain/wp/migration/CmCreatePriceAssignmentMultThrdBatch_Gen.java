 ...
 * $Revision: #1 $
 */
package com.splwg.cm.domain.wp.migration;
...
/**
  * Generated super class for the cmCreatePriceAssignmentMultThrdBatch batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class CmCreatePriceAssignmentMultThrdBatch_Gen extends AbstractBatchJob
{
   ...
   //~ Instance fields --------------------------------------------------------------------------------------
    ...
    public abstract static class CmCreatePriceAssignmentMultThrdBatchWorker_Gen
