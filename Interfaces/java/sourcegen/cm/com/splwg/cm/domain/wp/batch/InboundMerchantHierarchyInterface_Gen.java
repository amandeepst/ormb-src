...
/**
  * Generated super class for the inboundMerchantHierarchyInterface batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class InboundMerchantHierarchyInterface_Gen extends AbstractBatchJob
{
...
public final String getHierarchyType () {
        String result = privateGetSoftParameter("hierarchyType");
        if (result==null) reportRequiredParameter("hierarchyType");
        return result;
}
...
public final String getTxnSourceCode () {
    ...
    public abstract static class InboundMerchantHierarchyInterfaceWorker_Gen
