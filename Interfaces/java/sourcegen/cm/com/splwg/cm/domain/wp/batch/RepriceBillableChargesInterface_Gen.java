...
/**
  * Generated super class for the repriceBillableChargesInterface batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class RepriceBillableChargesInterface_Gen extends AbstractBatchJob
{
...
public final CharacteristicType getBillCycleChangeFlag () {
        String idValue = privateGetSoftParameter("billCycleChangeFlag");
	        CharacteristicType_Id id = new CharacteristicType_Id(idValue);

        CharacteristicType billCycleChangeFlag = id.getEntity();
	        validateSoftEntityExists("billCycleChangeFlag", id, billCycleChangeFlag);
	        return billCycleChangeFlag;
}


        @Override
       protected final void validateParameterTypes() {
           getBillCycleChangeFlag();
       }
    }

    public abstract static class RepriceBillableChargesInterfaceWorker_Gen
