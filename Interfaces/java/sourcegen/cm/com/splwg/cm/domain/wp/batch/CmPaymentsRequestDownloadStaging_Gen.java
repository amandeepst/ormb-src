...
/**
  * Generated super class for the cmPaymentsRequestDownloadStaging batch job
  *
  * @author Generated by com.splwg.tools.artifactgen.ArtifactGenerator
  */
public abstract class CmPaymentsRequestDownloadStaging_Gen extends AbstractBatchJob
{
...
public final String getTransactionSrcCd () {
        String result = privateGetSoftParameter("transactionSrcCd");
        return result;
}

public final String getAcctNumberTypeCd () {
        String result = privateGetSoftParameter("acctNumberTypeCd");
        if (result==null) reportRequiredParameter("acctNumberTypeCd");
        return result;
}
    ...
    public abstract static class CmPaymentsRequestDownloadStagingWorker_Gen
